...
# The string type Hello world! is displayed in the output
...
#  Nothing is observed because the code programming lines are a comment
...
# The string type I am using Python.
...
# The string type I am a security analyst.
# is displayed in the output
...
# The string type Python is useful for security!
# is displayed in the output
...
#  String outputs in python and how to comment lines 
